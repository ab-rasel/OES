                            ...
                            <tr>
                                ...
                                <th>
                                    <div class="social-menu">
                                        ...
                                        <ul>
                                            <li><a href="<?php echo $f_link; ?>" target="_blank"><i class="fa fa-facebook"></i></a></li>
                                            <li><a href="<?php echo $t_link; ?>" target="_blank"><i class="fa fa-twitter"></i></a></li>
                                            <li><a href="<?php echo $i_link; ?>" target="_blank"><i class="fa fa-instagram"></i></a></li>
                                            <li><a href="<?php echo $g_link; ?>" target="_blank"><i class="fa fa-google-plus"></i></a></li>
                                            <li><a href="<?php echo $l_link; ?>" target="_blank"><i class="fa fa-linkedin"></i></a></li>
                                        </ul>
                                    </div>
